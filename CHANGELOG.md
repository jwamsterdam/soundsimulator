...
- Default demo-audio wordt vooraf gedecodeerd, en de `AudioContext` wordt expliciet vanuit de tap-handler unlocked voor iOS Safari.
- Visibility cleanup heeft nu een korte vertraging en sluit alleen als audio daadwerkelijk speelt, zodat tijdelijke Safari/WebKit visibility-flitsen niet direct audio sluiten.
